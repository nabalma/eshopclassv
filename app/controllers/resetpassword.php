...
class Resetpassword extends Controller{
    ...
    public function index(){
     ...
     $user->resetpassword($_POST);
      ...
      $data["title"]="ClassV | Reset Password";
      $this->view("resetpassword/index",$data); // le parametre $path est une chaine de caractere correspondant au chemin du fichier a afficher, a partir du dosseir views
