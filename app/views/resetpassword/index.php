          ...
          <div class="card-body">
            ...
            <span class="col-4 d-flex align-items-center d-none d-sm-none d-md-block">
              ...
              <div class="col-8">
                ...
                <p class="text-center h1 fs-3 fw-bold mb-2 mx-1 mx-md-4 mt-1 d-none d-sm-block d-md-block">Mot de passe oublié</p>

                <!-- Affichage conditionnelle des erreurs de reset Password, sil yen a -->
                <?php 
                  if($_SERVER["REQUEST_METHOD"]=="POST"){

                     if(isset($_SESSION["reset_error"]) && $_SESSION["reset_error"]!==""){                    
                    //Registration Alert erreur
                    $this->view("resetpassword/error_reset");};

                    if(isset($_SESSION["reset_error"]) && $_SESSION["reset_error"]==""){
                      $this->view("resetpassword/success_info_passwd_instructions_sent");
                    }
                  }
                ?>
              ...
              <div class="row mb-1 mt-2">
                  <div class="d-flex justify-content-center mx-4 mb-1 ">  
                    <button type="submit" class="ms-3 red_button message_submit_btn trans_300 w-100 me-3">Demander une réinitialisation du mot de passe</button>                    
                  </div>            
              </div>
